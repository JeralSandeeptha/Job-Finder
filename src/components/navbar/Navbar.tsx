        ...
        <ul className="flex gap-15 items-center">
          ...
          {!isLoggedIn ? (
            <div className="flex items-center justify-between gap-5">
              <Link to="/register" className="px-[1rem] py-[0.5rem] rounded bg-[#009A4B] font-normal text-[1.2rem] text-[white] cursor-pointer">Register</Link>
              <Link to="/login" className="px-[1rem] py-[0.5rem] text-[#009A4B] bg-white rounded font-normal text-[1.2rem]">Login</Link>
            </div>
          ) : (
            <>
        ...
        <div className="lg:hidden fixed top-0 bottom-0 left-0 w-full h-full z-40 px-[20px] bg-[#00773A]">
          ...
          {!isLoggedIn ? (
            <div className="flex justify-between flex-col gap-5">
              <Link to="/register" className="px-[1rem] max-w-[200px] flex items-center justify-center py-[0.5rem] rounded bg-[#009A4B] font-normal text-[1.2rem] text-[white] cursor-pointer">Register</Link>
              <Link to="/login" className="max-w-[200px] flex items-center justify-center px-[1rem] py-[0.5rem] text-[#009A4B] bg-white rounded font-normal text-[1.2rem]">Login</Link>
            </div>
          ) : (
            <>
              {getLocalStorageItem("role") === "Recruiter" && (
